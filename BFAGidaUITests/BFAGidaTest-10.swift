...
final class BFAGidaUITest_10: XCTestCase {
    ...
    // Senario-10 : Fiyat kısmına string karakter alamaz. Tersten test edildi.
    ...
    func testExample() throws {
        ...
        app.textFields["Fiyat"].tap()
        app.typeText("fiyat") // İndirimli Ürünler butonuna tıklıyor.
